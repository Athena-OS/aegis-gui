...
from aegis_gui.manualpartitioning import filesystems, mountpoints
from aegis_gui.classes.partition import Partition


@Gtk.Template(resource_path="/org/athenaos/aegisgui/widgets/partition.ui")
class PartitionEntry(Adw.ActionRow):
    ...
    def on_filesystem_select(self, widget):
        ...
        print("select " + self.partition.generate_aegis_entry())
