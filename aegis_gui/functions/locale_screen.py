...
from aegis_gui.widgets.locale import LocaleEntry
from aegis_gui.widgets.selected_locale import SelectedLocale
from aegis_gui.utils.gtk_helpers import set_list_text



@Gtk.Template(resource_path="/org/athenaos/aegisgui/pages/locale/locale_screen.ui")
class LocaleScreen(AegisScreen, Adw.Bin):
    ...
    def __init__(self, window, locations, set_valid, application, **kwargs):
        ...
        builder = Gtk.Builder.new_from_resource(
            "/org/athenaos/aegisgui/pages/locale/locale_dialog.ui"
        )
