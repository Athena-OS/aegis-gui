...
from aegis_gui.widgets.layout import KeyboardLayout
...
@Gtk.Template(resource_path="/org/athenaos/aegisgui/pages/keyboard/keyboard_screen.ui")
class KeyboardScreen(AegisScreen, Adw.Bin):
    ...
    def __init__(self, window, keymaps, set_valid, application, **kwargs):
        ...
        builder = Gtk.Builder.new_from_resource(
            "/org/athenaos/aegisgui/pages/keyboard/keyboard_dialog.ui"
        )
