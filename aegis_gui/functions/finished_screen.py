...
@Gtk.Template(resource_path="/org/athenaos/aegisgui/pages/finished_screen.ui")
class FinishedScreen(AegisScreen, Adw.Bin):
    ...
    def output(self, widget):
        with open("/tmp/aegis-gui-output.txt", "r") as f:
            output = f.read()
        LogWindow(window=self.window, title="Aegis log view", content=output).present()
