...
from aegis_gui.widgets.timezone import TimezoneEntry
...
@Gtk.Template(resource_path="/org/athenaos/aegisgui/pages/timezone/timezone_screen.ui")
class TimezoneScreen(AegisScreen, Adw.Bin):
    ...
    def __init__(self, window, locations, set_valid, application, **kwargs):
        ...
        builder = Gtk.Builder.new_from_resource(
            "/org/athenaos/aegisgui/pages/timezone/timezone_dialog.ui"
        )
